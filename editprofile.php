...
<div class="input-group">
<label>Roll No</label>
<input type="text" name="roll" value="<?php echo $di[1]; ?>" required>
</div>

<div class="input-group">
<label>Email</label>
<input type="email" name="email" value="<?php echo $di[2]; ?>" readonly>
</div>
...
<input type="text" name="dept" value="<?php echo $di[4]; ?>" required>
</div>

<div class="input-group">
<label>Contact</label>
<input type="text" name="contact" value="<?php echo $di[5]; ?>" required>
</div>

<div class="input-group">
<label>City</label>
<input type="text" name="city" value="<?php echo $di[6]; ?>" required>
</div>

<div class="input-group">
<label>State</label>
<input type="text" name="state" value="<?php echo $di[7]; ?>" required>
</div>
